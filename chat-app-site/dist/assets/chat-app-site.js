...
;define("chat-app-site/components/nav-bar", ["exports", "@ember/component", "@ember/template-factory", "@ember/component/template-only"], function (_exports, _component, _templateFactory, _templateOnly) {
  ...
  /*
    ...
    <div class="links">
      <LinkTo @route="history" class="menu-history">
        History
      </LinkTo>
    </div>
...
;define("chat-app-site/models/individual-message", ["exports", "@ember-data/model"], function (_exports, _model) {
  "use strict";
  ...
  let IndividualMessageModel = (_class = class IndividualMessageModel extends _model.default {
    constructor() {
      super(...arguments);

      _initializerDefineProperty(this, "text", _descriptor, this);

      _initializerDefineProperty(this, "date_time", _descriptor2, this);
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "date_time", [_model.attr], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  })), _class);
  _exports.default = IndividualMessageModel;
});
...
;define("chat-app-site/routes/history", ["exports", "@ember/routing/route"], function (_exports, _route) {
  "use strict";
  ...
  class HistoryRoute extends _route.default {}
...
;define("chat-app-site/templates/history", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  var _default = (0, _templateFactory.createTemplateFactory)({
    ...
    "moduleName": "chat-app-site/templates/history.hbs",
    "isStrictMode": false
  });
...
;
          if (!runningTests) {
            require("chat-app-site/app")["default"].create({"name":"chat-app-site","version":"0.0.0+7afbffb7"});
          }
